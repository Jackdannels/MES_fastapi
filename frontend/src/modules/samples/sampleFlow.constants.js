...
const APPEARANCE_PRE_EXPERIMENT_STOCKED_STATUS = "实验前外观检测间存放";
const POST_EXPERIMENT_STAGING_SENT_STATUS = "送至暂存间";
const POST_EXPERIMENT_STAGING_DISPATCH_TIME_LABEL = "实验后送至暂存间";
const POST_EXPERIMENT_STAGING_STOCKED_STATUS = "实验后暂存间存放";
const APPEARANCE_REQUIRED_KEYWORDS = ["盐雾", "霉菌", "高低温湿热"];
