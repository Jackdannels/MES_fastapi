...
describe("samplesFlowModel", () => {
  ...
  test("preserves the system-only canceled status while a tray remains in the mold laboratory", () => {
    ...
    expect(samplesFlowModelPublicApi.normalizeLifecycleStatus("", "霉菌取消后恢复处理中")).toBe("霉菌取消后恢复处理中");
  });
  ...
  test("buildTrayFlowView keeps previous partial-axis laboratory step times after a later experiment withdraws to staging", () => {
    const taskCode = "SYLU-2026-08-001";
    const trayCode = `${taskCode}-TP-001`;
    const impactExperimentCode = `${taskCode}-A`;
    ...
    const completedAxisCodes = ["x+", "x-", "y+"];
    const remainingAxisCodes = ["y-", "z+", "z-"];
    const allAxisCodes = [...completedAxisCodes, ...remainingAxisCodes];
    ...
    const view = buildTrayFlowView({
      ...
      samples: [
        {
          ...
          task_code: taskCode,
          history: [
            { action: "实验任务撤回", detail: `${taskCode} / 四综合试验 / 撤回至已到达暂存间（试验间内撤回当前实验任务）`, location: "恒温恒湿间（暂存间）", status: "已到达暂存间", time: "2026-07-04 10:04:24", tray_code: trayCode },
            { action: "任务比对", detail: `${taskCode} / 四综合试验 / 已到达实验室 / 托盘：${trayCode}`, location: "四综合实验室", status: "已到达实验室", time: "2026-07-04 10:04:21", tray_code: trayCode },
            { action: "暂存间扫码出库", detail: `${trayCode} 送至 四综合实验室`, location: "四综合实验室", status: "送至实验室", time: "2026-07-04 10:03:57", tray_code: trayCode },
            { action: "暂存间扫码入库", detail: `${trayCode} 已到达暂存间`, location: "恒温恒湿间（暂存间）", status: "已到达暂存间", time: "2026-07-04 10:03:51", tray_code: trayCode },
            { action: "实验完成", detail: `${taskCode} / 振动试验 / 振动试验部分完成 3/6轴`, location: "振动一室", status: "振动试验部分完成 3/6轴", time: "2026-07-04 10:03:07", tray_code: trayCode },
            { action: "开始实验", detail: `${taskCode} / 振动试验 / 实验进行中 / 托盘：${trayCode}`, location: "振动一室", status: "实验进行中", time: "2026-07-04 09:56:33", tray_code: trayCode },
            { action: "实验确认", detail: `${taskCode} / 振动试验 / 实验准备就绪 / 托盘：${trayCode}`, location: "振动一室", status: "实验准备就绪", time: "2026-07-04 09:56:32", tray_code: trayCode },
            { action: "样品安装", detail: `${taskCode} / 振动试验 / 工装夹具安装 / 托盘：${trayCode}`, location: "振动一室", status: "工装夹具安装", time: "2026-07-04 09:56:28", tray_code: trayCode },
            { action: "任务比对", detail: `${taskCode} / 振动试验 / 已到达实验室 / 托盘：${trayCode}`, location: "振动一室", status: "已到达实验室", time: "2026-07-04 09:56:07", tray_code: trayCode },
            { action: "实验完成", detail: `${taskCode} / 盐雾试验 / 实验已完成`, location: "盐雾试验室", status: "实验已完成", time: "2026-07-04 09:55:43", tray_code: trayCode },
            { action: "实验完成", detail: `${taskCode} / 冲击试验 / 冲击试验部分完成 3/6轴`, location: "冲击一室", status: "冲击试验部分完成 3/6轴", time: "2026-07-04 09:53:24", tray_code: trayCode },
          ],
          trays: [
            {
              quantity: 1,
              status: "已到达暂存间",
              target_experiment_code: comprehensiveExperimentCode,
              target_lab: "四综合实验室",
              tray_code: trayCode,
            },
          ],
      ...
      experiments: [
        { axis_codes: allAxisCodes, experiment_code: impactExperimentCode, experiment_name: "冲击试验", required_device: "冲击一室", task_code: taskCode },
        ...
        { axis_codes: allAxisCodes, experiment_code: vibrationExperimentCode, experiment_name: "振动试验", required_device: "振动一室", task_code: taskCode },
      ],
      experimentTrays: [
        { experiment_code: impactExperimentCode, task_code: taskCode, tray_code: trayCode },
      ...
      experimentRuns: [
        { axis_codes: completedAxisCodes, ended_at: "2026-07-04 09:53:24", experiment_code: impactExperimentCode, run_no: "RUN-IMPACT-FIRST", status: "实验已完成", task_code: taskCode, tray_codes: [trayCode] },
        { ended_at: "2026-07-04 09:55:43", experiment_code: saltExperimentCode, run_no: "RUN-SALT-DONE", status: "实验已完成", task_code: taskCode, tray_codes: [trayCode] },
        { axis_codes: completedAxisCodes, ended_at: "2026-07-04 10:03:07", experiment_code: vibrationExperimentCode, run_no: "RUN-VIBRATION-FIRST", started_at: "2026-07-04 09:56:33", status: "实验已完成", task_code: taskCode, tray_codes: [trayCode] },
      ],
      experimentRunTrays: [
        { ended_at: "2026-07-04 09:53:24", experiment_code: impactExperimentCode, run_no: "RUN-IMPACT-FIRST", run_tray_status: "实验已完成", task_code: taskCode, tray_code: trayCode },
        { ended_at: "2026-07-04 09:55:43", experiment_code: saltExperimentCode, run_no: "RUN-SALT-DONE", run_tray_status: "实验已完成", task_code: taskCode, tray_code: trayCode },
        { ended_at: "2026-07-04 10:03:07", experiment_code: vibrationExperimentCode, run_no: "RUN-VIBRATION-FIRST", run_tray_status: "实验已完成", task_code: taskCode, tray_code: trayCode },
      ],
      experimentRunSteps: [
        ...completedAxisCodes.map((axisCode) => ({ axis_code: axisCode, experiment_code: impactExperimentCode, run_no: "RUN-IMPACT-FIRST", status: "实验已完成", task_code: taskCode })),
        ...completedAxisCodes.map((axisCode) => ({ axis_code: axisCode, experiment_code: vibrationExperimentCode, run_no: "RUN-VIBRATION-FIRST", status: "实验已完成", task_code: taskCode })),
      ],
      schedules: [
        { axis_codes: remainingAxisCodes, device: "冲击一室", experiment_code: impactExperimentCode, status: "已排程", task_code: taskCode },
        { axis_codes: remainingAxisCodes, device: "振动一室", experiment_code: vibrationExperimentCode, status: "已排程", task_code: taskCode },
        { device: "四综合实验室", experiment_code: comprehensiveExperimentCode, status: "已排程", task_code: taskCode },
      ],
    });

    expect(view.steps.find((step) => step.label === "已到达实验室")).toEqual(
      expect.objectContaining({ reached: true, time: "2026-07-04 09:56:07" }),
    );
    expect(view.steps.find((step) => step.label === "工装夹具安装")).toEqual(
      expect.objectContaining({ reached: true, time: "2026-07-04 09:56:28" }),
    );
    expect(view.steps.find((step) => step.label === "实验准备就绪")).toEqual(
      expect.objectContaining({ reached: true, time: "2026-07-04 09:56:32" }),
    );
    expect(view.steps.find((step) => step.label === "四综合试验未完成")).toEqual(
      expect.objectContaining({ reached: false, time: "" }),
    );
  ...
  test("buildTrayFlowView folds 2/6 and 4/6 impact stages into one final completion after another experiment and manufacturer return", () => {
    ...
    const view = buildTrayFlowViewRaw({
      ...
      samples: [
        {
          ...
          history: [
            ...
            { action: "实验完成", detail: `${taskCode} / 冲击试验 / 冲击试验部分完成 4/6轴`, location: "冲击一室", status: "冲击试验部分完成 4/6轴", time: "2026-07-02 13:51:41", tray_code: trayCode },
            ...
            { action: "实验完成", detail: `${taskCode} / 冲击试验 / 冲击试验部分完成 2/6轴`, location: "冲击一室", status: "冲击试验部分完成 2/6轴", time: "2026-07-02 13:49:23", tray_code: trayCode },
          ],
          trays: [
            {
              quantity: 1,
      ...
      experiments: [
        { axis_codes: ["x+", "x-", "y+", "y-", "z+", "z-"], experiment_code: impactExperimentCode, experiment_name: "冲击试验", required_device: "冲击一室", task_code: taskCode },
        { experiment_code: saltExperimentCode, experiment_name: "盐雾试验", required_device: "盐雾试验室", task_code: taskCode },
        { experiment_code: comprehensiveExperimentCode, experiment_name: "四综合试验", required_device: "四综合实验室", task_code: taskCode },
      ...
      experimentRuns: [
        { axis_codes: ["x+", "x-"], ended_at: "2026-07-02 13:49:23", experiment_code: impactExperimentCode, run_no: "RUN-IMPACT-1", status: "实验已完成", task_code: taskCode, tray_codes: [trayCode] },
        { axis_codes: ["y+", "y-"], ended_at: "2026-07-02 13:51:41", experiment_code: impactExperimentCode, run_no: "RUN-IMPACT-2", status: "实验已完成", task_code: taskCode, tray_codes: [trayCode] },
        ...
        { axis_codes: ["z+", "z-"], ended_at: "2026-07-02 14:23:48", experiment_code: impactExperimentCode, run_no: "RUN-IMPACT-3", status: "实验已完成", task_code: taskCode, tray_codes: [trayCode] },
      ],
      experimentRunTrays: [
        ...
        { ended_at: "2026-07-02 13:51:41", experiment_code: impactExperimentCode, run_no: "RUN-IMPACT-2", run_tray_status: "实验已完成", task_code: taskCode, tray_code: trayCode },
        ...
        { ended_at: "2026-07-02 14:23:48", experiment_code: impactExperimentCode, run_no: "RUN-IMPACT-3", run_tray_status: "实验已完成", task_code: taskCode, tray_code: trayCode },
      ],
      experimentRunSteps: [
        ...["x+", "x-"].map((axisCode) => ({ axis_code: axisCode, experiment_code: impactExperimentCode, run_no: "RUN-IMPACT-1", status: "实验已完成", task_code: taskCode })),
        ...["y+", "y-"].map((axisCode) => ({ axis_code: axisCode, experiment_code: impactExperimentCode, run_no: "RUN-IMPACT-2", status: "实验已完成", task_code: taskCode })),
        ...["z+", "z-"].map((axisCode) => ({ axis_code: axisCode, experiment_code: impactExperimentCode, run_no: "RUN-IMPACT-3", status: "实验已完成", task_code: taskCode })),
    ...
    expect(labels.some((label) => label.startsWith("冲击试验部分完成"))).toBe(false);
    expect(view.steps.find((step) => step.label === "冲击试验已完成")).toEqual(
    ...
    expect(labels.some((label) => label.startsWith("待继续冲击试验"))).toBe(false);
    expect(view.currentStatus).toBe(`当前托盘：${trayCode} | 当前状态：厂家收回`);
  });
  ...
  test("buildTrayFlowView keeps completed axes after a continuation comparison withdraws to staging", () => {
    const taskCode = "SYLU-2026-07-030";
    const trayCode = `${taskCode}-TP-001`;
    const experimentCode = `${taskCode}-G`;
    const runNo = "run-20260722102843249796";
    const view = buildTrayFlowView({
      taskCode,
      trayCode,
      location: "恒温恒湿间（暂存间）",
      ...
      samples: [{
        ...
        flow_status: "已到达暂存间",
        history: [
          { action: "实验任务撤回", detail: `${taskCode} / 冲击试验 / 撤回至已到达暂存间（试验间内撤回当前实验任务）`, location: "恒温恒湿间（暂存间）", status: "已到达暂存间", time: "2026-07-22 10:29:45", tray_code: trayCode },
          { action: "任务比对", detail: `${taskCode} / 冲击试验 / 已到达实验室 / 托盘：${trayCode}`, location: "冲击二室", status: "已到达实验室", time: "2026-07-22 10:29:41", tray_code: trayCode },
          { action: "暂存间扫码出库", detail: `${trayCode} 送至 冲击二室`, location: "冲击二室", status: "送至实验室", time: "2026-07-22 10:29:28", tray_code: trayCode },
          { action: "暂存间扫码入库", detail: `${trayCode} 已到达暂存间`, location: "恒温恒湿间（暂存间）", status: "已到达暂存间", time: "2026-07-22 10:29:25", tray_code: trayCode },
          { action: "实验任务撤回", detail: `${taskCode} / 冲击试验 / 撤回至冲击试验部分完成`, location: "冲击二室", status: "冲击试验部分完成 2/6轴", time: "2026-07-22 10:29:14", tray_code: trayCode },
          { action: "实验完成", detail: `${taskCode} / 冲击试验 / 冲击试验部分完成 2/6轴`, location: "冲击二室", status: "冲击试验部分完成 2/6轴", time: "2026-07-22 10:28:54", tray_code: trayCode },
        ],
        trays: [{
          quantity: 1,
          status: "已到达暂存间",
      ...
      experimentRunSteps: ["z+", "z-"].map((axisCode) => ({
        axis_code: axisCode,
        ended_at: "2026-07-22 10:28:54",
        experiment_code: experimentCode,
        run_no: runNo,
      ...
      schedules: [
        { axis_codes: ["z+", "z-"], device: "冲击二室", experiment_code: experimentCode, status: "实验进行中", sub_experiment_code: `${experimentCode}-AXIS-001`, task_code: taskCode },
        { axis_codes: ["x+", "x-"], device: "冲击二室", experiment_code: experimentCode, status: "已排程", sub_experiment_code: `${experimentCode}-AXIS-002`, task_code: taskCode },
      ],
    });

    expect(view.status).toBe("已到达暂存间");
    expect(view.steps.find((step) => step.label === "已到达暂存间")).toEqual(expect.objectContaining({ active: true }));
    expect(view.steps.find((step) => step.label === "冲击试验部分完成 2/6轴")).toEqual(
      expect.objectContaining({ active: false, reached: true, time: "2026-07-22 10:28:54" }),
    );
  });

  test("buildTrayFlowView keeps SYLU-2026-07-029 partial impact axes after withdrawing to post-experiment appearance", () => {
    const taskCode = "SYLU-2026-07-029";
    const trayCode = `${taskCode}-TP-001`;
    ...
    const view = buildTrayFlowView({
      ...
      schedules: [
        { device: "高低温湿热二室", experiment_code: hotHumidExperimentCode, status: "实验进行中", task_code: taskCode },
        { axis_codes: ["y-", "z+", "z-"], device: "冲击二室", experiment_code: experimentCode, status: "实验进行中", sub_experiment_code: `${experimentCode}-AXIS-001`, task_code: taskCode },
        { axis_codes: ["x-", "y+"], device: "冲击二室", experiment_code: experimentCode, status: "已排程", sub_experiment_code: `${experimentCode}-AXIS-002`, task_code: taskCode },
      ],
      stagingEvents: [
    ...
    expect(view.status).toBe("实验后外观检测间存放");
    expect(view.currentStatus).toBe(`当前托盘：${trayCode} | 当前状态：实验后外观检测间存放`);
    expect(view.steps.find((step) => step.label === "实验后外观检测间存放")).toEqual(
  ...
  test("buildTrayFlowView shows one final impact completion for returned SYLU-2026-07-029 after all three axis batches", () => {
    const taskCode = "SYLU-2026-07-029";
    const trayCode = `${taskCode}-TP-001`;
    const impactCode = `${taskCode}-A`;
    const hotHumidCode = `${taskCode}-B`;
    const comprehensiveCode = `${taskCode}-C`;
    const impactRuns = [
      { axes: ["z+", "z-"], endedAt: "2026-07-22 13:43:03", runNo: "RUN-IMPACT-1" },
      { axes: ["x+", "x-"], endedAt: "2026-07-22 13:52:17", runNo: "RUN-IMPACT-2" },
      { axes: ["y+", "y-"], endedAt: "2026-07-22 14:13:07", runNo: "RUN-IMPACT-3" },
    ];
    const view = buildTrayFlowView({
      taskCode,
      trayCode,
      ...
      samples: [{
        ...
        status: "厂家收回",
        flow_status: "厂家收回",
        trays: [{ tray_code: trayCode, status: "厂家收回", target_lab: "冲击二室" }],
        history: [
          { action: "厂家收回", detail: `${trayCode} 厂家收回`, location: "厂家收回", status: "厂家收回", time: "2026-07-22 14:13:19", tray_code: trayCode },
          { action: "实验完成", detail: `${taskCode} / 冲击试验 / 实验已完成`, location: "冲击二室", status: "实验已完成", time: "2026-07-22 14:13:07", tray_code: trayCode },
          { action: "实验完成", detail: `${taskCode} / 高低温湿热试验 / 实验已完成`, location: "高低温湿热二室", status: "实验已完成", time: "2026-07-22 13:59:45", tray_code: trayCode },
          { action: "实验完成", detail: `${taskCode} / 冲击试验 / 冲击试验部分完成 4/6轴`, location: "冲击二室", status: "冲击试验部分完成 4/6轴", time: "2026-07-22 13:52:17", tray_code: trayCode },
          { action: "实验完成", detail: `${taskCode} / 冲击试验 / 冲击试验部分完成 2/6轴`, location: "冲击二室", status: "冲击试验部分完成 2/6轴", time: "2026-07-22 13:43:03", tray_code: trayCode },
        ],
      }],
      experiments: [
        { axis_codes: ["x+", "x-", "y+", "y-", "z+", "z-"], experiment_code: impactCode, experiment_name: "冲击试验", required_device: "冲击试验", status: "实验已完成", task_code: taskCode },
        { experiment_code: hotHumidCode, experiment_name: "高低温湿热试验", required_device: "高低温湿热试验", status: "实验已完成", task_code: taskCode },
        { experiment_code: comprehensiveCode, experiment_name: "四综合试验", required_device: "四综合试验", status: "实验已完成", task_code: taskCode },
      ],
      experimentTrays: [impactCode, hotHumidCode, comprehensiveCode].map((experimentCode) => ({ experiment_code: experimentCode, task_code: taskCode, tray_code: trayCode })),
      experimentRuns: [
        ...impactRuns.map((run, index) => ({ axis_codes: run.axes, ended_at: run.endedAt, experiment_code: impactCode, run_no: run.runNo, status: "实验已完成", sub_experiment_code: `${impactCode}-AXIS-00${index + 1}`, task_code: taskCode, tray_codes: [trayCode] })),
        { ended_at: "2026-07-22 13:59:45", experiment_code: hotHumidCode, run_no: "RUN-HOT-HUMID", status: "实验已完成", task_code: taskCode, tray_codes: [trayCode] },
      ],
      experimentRunTrays: [
        ...impactRuns.map((run, index) => ({ ended_at: run.endedAt, experiment_code: impactCode, run_no: run.runNo, run_tray_status: "实验已完成", sub_experiment_code: `${impactCode}-AXIS-00${index + 1}`, task_code: taskCode, tray_code: trayCode })),
        { ended_at: "2026-07-22 13:59:45", experiment_code: hotHumidCode, run_no: "RUN-HOT-HUMID", run_tray_status: "实验已完成", task_code: taskCode, tray_code: trayCode },
        { ended_at: "2026-07-22 14:13:19", experiment_code: comprehensiveCode, run_no: "RETURNED-C", run_tray_status: "厂家收回", task_code: taskCode, tray_code: trayCode },
      ],
      experimentRunSteps: impactRuns.flatMap((run, index) => run.axes.map((axisCode) => ({ axis_code: axisCode, ended_at: run.endedAt, experiment_code: impactCode, run_no: run.runNo, status: "实验已完成", sub_experiment_code: `${impactCode}-AXIS-00${index + 1}`, task_code: taskCode }))),
      schedules: [],
    });

    const impactSteps = view.steps.filter((step) => step.label.startsWith("冲击试验"));
    expect(impactSteps).toEqual([
      expect.objectContaining({ label: "冲击试验已完成", reached: true, time: "2026-07-22 14:13:07" }),
    ]);
    expect(view.currentStatus).toBe(`当前托盘：${trayCode} | 当前状态：厂家收回`);
  });

  test("buildTrayFlowView starts a new mold cycle after cancel recovery outbound without reusing old preparation", () => {
    ...
    const view = buildTrayFlowView({
      ...
      experiments: [
        ...
        { experiment_code: `${taskCode}-B`, experiment_name: "四综合试验", required_device: "四综合实验室", task_code: taskCode },
      ],
      experimentTrays: [
      ...
      samples: [{
        ...
        history: [
          ...
          { action: "外观检测间扫码入库", detail: `${trayCode} 霉菌取消后恢复处理中`, location: "外观检测间", status: "霉菌取消后恢复处理中", time: "2026-09-03 21:27:41", tray_code: trayCode },
          { action: "取消本次霉菌实验", detail: `${taskCode} / 霉菌试验 / 实验已取消 / 原因：霉菌未按预期繁殖`, location: "霉菌试验室", status: "实验已取消", time: "2026-09-03 21:27:01", tray_code: trayCode },
        ...
        status: "送至实验室",
        task_code: taskCode,
        trays: [{ status: "送至实验室", target_experiment_code: moldCode, target_lab: "霉菌试验室", tray_code: trayCode }],
      }],
      schedules: [{ id: "schedule-new", task_code: taskCode, experiment_code: moldCode, device: "霉菌试验室", status: "已排程" }],
      stagingEvents: [
        { action: "stock_in", appearance_phase: "post_experiment", experiment_code: moldCode, room: "appearance", status: "实验后外观检测间存放", target_experiment_code: moldCode, task_code: taskCode, time: "2026-09-03 21:27:41", tray_code: trayCode },
        { action: "stock_out", appearance_phase: "post_experiment", room: "appearance", target_experiment_code: moldCode, target_lab: "霉菌试验室", target_schedule_id: "schedule-new", target_type: "lab", task_code: taskCode, time: "2026-09-03 21:28:11", tray_code: trayCode },
      ],
      status: "送至实验室",
      taskCode,
      trayCode,
  ...
  test("buildTrayFlowView folds a canceled multi-experiment mold attempt and keeps its requirement unfinished", () => {
    ...
    expect(canceledView.steps[recoveryIndex]).toEqual(expect.objectContaining({
      active: false,
      reached: false,
      time: "",
    }));
  ...
  test("buildTrayFlowView folds a canceled single mold attempt and keeps arrival plus unfinished requirement", () => {
    ...
    const view = buildTrayFlowView({
      ...
      experimentRunTrays: [{
        ended_at: "2026-09-04 14:18:18",
        experiment_code: experimentCode,
        run_no: "RUN-SINGLE-MOLD-CANCELED",
        run_tray_status: "实验已取消",
        task_code: taskCode,
        tray_code: trayCode,
      }],
      ...
      samples: [{
        code: `${taskCode}-SP-001`,
        history: [
          { action: "任务已确认入库", status: "到货", time: "2026-09-04 14:17:40", tray_code: trayCode },
          { action: "样品分装托盘", status: "运输中", time: "2026-09-04 14:17:28", tray_code: trayCode },
        ],
        location: "霉菌试验室",
        status: "实验已取消",
        task_code: taskCode,
    ...
    expect(view.steps.find((step) => step.key === "in_transit")).toEqual(
      expect.objectContaining({ reached: true, time: "2026-09-04 14:17:28" }),
    );
  ...
  test("buildTrayFlowView clears the previous recovery time after a second mold cancellation", () => {
    const taskCode = "TASK-MOLD-CANCEL-TWICE";
    const trayCode = `${taskCode}-TP-001`;
    const experimentCode = `${taskCode}-A`;
    const view = buildTrayFlowView({
      currentExperimentCode: experimentCode,
      experiments: [{ experiment_code: experimentCode, experiment_name: "霉菌试验", required_device: "霉菌试验室", task_code: taskCode }],
      experimentRunTrays: [
        { ended_at: "2026-09-04 10:00:00", experiment_code: experimentCode, run_no: "RUN-CANCEL-1", run_tray_status: "实验已取消", task_code: taskCode, tray_code: trayCode },
        { ended_at: "2026-09-04 12:00:00", experiment_code: experimentCode, run_no: "RUN-CANCEL-2", run_tray_status: "实验已取消", task_code: taskCode, tray_code: trayCode },
      ],
      experimentTrays: [{ experiment_code: experimentCode, task_code: taskCode, tray_code: trayCode }],
      location: "霉菌试验室",
      samples: [{
        code: `${taskCode}-SP-001`,
        history: [{ action: "任务已确认入库", status: "到货", time: "2026-09-04 09:00:00", tray_code: trayCode }],
        location: "霉菌试验室",
        status: "实验已取消",
        task_code: taskCode,
        trays: [{ status: "实验已取消", tray_code: trayCode }],
      ...
      stagingEvents: [
        { action: "stock_in", appearance_phase: "mold_cancel_recovery", experiment_code: experimentCode, recovery_cycle_id: "RUN-CANCEL-1", room: "appearance", source_experiment_code: experimentCode, source_run_no: "RUN-CANCEL-1", status: "霉菌取消后恢复处理中", task_code: taskCode, time: "2026-09-04 10:30:00", tray_code: trayCode },
        { action: "stock_out", appearance_phase: "mold_cancel_recovery", recovery_cycle_id: "RUN-CANCEL-1", room: "appearance", source_experiment_code: experimentCode, source_run_no: "RUN-CANCEL-1", target_experiment_code: experimentCode, task_code: taskCode, time: "2026-09-04 10:40:00", tray_code: trayCode },
      ],
      status: "实验已取消",
      taskCode,
      trayCode,
    ...
    expect(view.steps.find((step) => step.label === "霉菌试验已取消")).toEqual(
      expect.objectContaining({ active: true, time: "2026-09-04 12:00:00" }),
    );
  });

  test("projects current salt pause appearance and return time per tray", () => {
    const taskCode = "TASK-SALT-MID-FLOW";
    const experimentCode = "EXP-SALT-MID-FLOW";
    const trayCode = "TP-SALT-MID-FLOW";
    const baseInput = {
      currentExperimentCode: experimentCode,
      experimentRunPauses: [{
        inspection_tray_codes: [trayCode, "TP-OTHER"], lab_code: "LAB_SALT", pause_no: "PAUSE-CURRENT",
        paused_at: "2026-09-03 10:00:00", run_no: "RUN-SALT-MID", status: "实验暂停",
      }],
      experimentRuns: [{
        device: "盐雾试验室", experiment_code: experimentCode, run_no: "RUN-SALT-MID",
        status: "实验暂停", task_code: taskCode,
      }],
      experimentRunTrays: [
        { experiment_code: experimentCode, run_no: "RUN-SALT-MID", run_tray_status: "实验进行中", task_code: taskCode, tray_code: trayCode },
        { experiment_code: experimentCode, run_no: "RUN-SALT-MID", run_tray_status: "实验进行中", task_code: taskCode, tray_code: "TP-OTHER" },
      ],
      experimentTrays: [{ experiment_code: experimentCode, task_code: taskCode, tray_code: trayCode }],
      experiments: [{
        experiment_code: experimentCode, experiment_name: "盐雾试验", required_device: "盐雾试验室", task_code: taskCode,
      }],
      location: "外观检测间",
      samples: [{
        code: "SP-SALT-MID-FLOW", location: "外观检测间", status: "中途外观检查中", task_code: taskCode,
        trays: [{ quantity: 1, status: "中途外观检查中", target_lab: "盐雾试验室", tray_code: trayCode }],
      }],
    ...
    const stockInEvent = {
      action: "stock_in", appearance_phase: "mid_experiment", pause_no: "PAUSE-CURRENT", room: "appearance",
      run_no: "RUN-SALT-MID", time: "2026-09-03 10:10:00", tray_code: trayCode,
    };
    const stockedFlow = buildTrayFlowViewRaw({
      ...baseInput,
      stagingEvents: [
        { ...stockInEvent, pause_no: "PAUSE-OLD", time: "2026-09-03 09:10:00" },
        { ...stockInEvent, tray_code: "TP-OTHER", time: "2026-09-03 10:05:00" },
        stockInEvent,
      ],
    });
    const pausedIndex = stockedFlow.steps.findIndex((step) => step.label === "盐雾试验进行中（暂停）");
    const appearanceIndex = stockedFlow.steps.findIndex((step) => step.label === "中途外观检测");
    expect(appearanceIndex).toBe(pausedIndex + 1);
    expect(stockedFlow.steps[appearanceIndex]).toEqual(expect.objectContaining({
      active: true, time: "2026-09-03 10:10:00",
    }));

    const returnedAt = "2026-09-03 10:20:00";
    const returnedFlow = buildTrayFlowViewRaw({
      ...baseInput,
      stagingEvents: [
        stockInEvent,
        { ...stockInEvent, action: "stock_out", target_lab: "盐雾试验室", time: returnedAt },
      ],
    });
    ...
    const comparedFlow = buildTrayFlowViewRaw({
      ...baseInput,
      stagingEvents: [
        stockInEvent,
        { ...stockInEvent, action: "stock_out", target_lab: "盐雾试验室", time: returnedAt },
        { action: "resume_preparation_started", pause_no: "PAUSE-CURRENT", room: "laboratory_resume_preparation", run_no: "RUN-SALT-MID", time: "2026-09-03 10:21:00", tray_code: trayCode },
        { action: "resume_preparation_compared", pause_no: "PAUSE-CURRENT", room: "laboratory_resume_preparation", run_no: "RUN-SALT-MID", time: comparedAt, tray_code: trayCode },
      ],
    });
    expect(comparedFlow.status).toBe("已到达实验室");
    expect(comparedFlow.steps.find((step) => step.label === "盐雾试验进行中（暂停）"))
    ...
    const resumedFlow = buildTrayFlowViewRaw({
      ...baseInput,
      experimentRunPauses: [{
        ...baseInput.experimentRunPauses[0],
        resumed_at: "2026-09-03 10:30:00",
        status: "实验已恢复",
      }],
      experimentRuns: [{
        ...baseInput.experimentRuns[0],
        status: "实验进行中",
      }],
      stagingEvents: [
        stockInEvent,
    ...
    expect(resumedFlow.steps.find((step) => step.label === "送至盐雾试验室"))
      .toEqual(expect.objectContaining({ time: returnedAt }));
    expect(resumedFlow.steps.some((step) => step.pauseResetRequired)).toBe(false);
  });
});
