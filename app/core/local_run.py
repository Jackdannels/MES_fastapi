...
APP_ENV_KEYS = {
    ...
    "FRONTEND_ORIGINS",
    "STORAGE_BACKEND",
    "TEST_DATA_BACKUP_PATH",
    "TEST_DATA_BACKUP_STATE_PATH",
    "TEST_DATA_BACKUP_INTERVAL_SECONDS",
    "TEST_DATA_BACKUP_TIMEOUT_SECONDS",
    "TEST_DATA_BACKUP_BATCH_SIZE",
    "MYSQL_HOST",
    "MYSQL_PORT",
    "MYSQL_USER",
    "MYSQL_PASSWORD",
    ...
    "MQTT_QOS",
    "MQTT_TOPIC_PREFIX",
    "MQTT_HTTP_EVENT_INGRESS_ENABLED",
