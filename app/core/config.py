...
class Settings(BaseSettings):
    ...
    FRONTEND_ORIGINS: str = "http://mes-server:5173,http://192.168.110.15:5173,http://127.0.0.1:5173,http://localhost:5173"
    TEST_DATA_PUBLIC_BASE_URL: str = "http://mes-server:8000"
