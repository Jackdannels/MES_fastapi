...
function getLabels() {
  ...
  return {
    ...
    preRetentionLocation: data.labelPreRetentionLocation || data.labelRetentionLocation || "Pre-retention",
    postRetentionLocation: data.labelPostRetentionLocation || "Post-retention",
    retentionLocation: data.labelRetentionLocation || data.labelPreRetentionLocation || "Pre-retention",
